...
Per the [NDA](https://nda.nih.gov/) agreement, I am not permitted to share raw MRI data. However, after consulting with the NDA program lead, I am authorized to share *derived* data, such as the FIB files. For access to other data, you can request it directly through [NDA](https://nda.nih.gov/). Once you have the Data Use Agreement (DUA), feel free to share it with me, and I can provide you with a link to access the SRC files.
