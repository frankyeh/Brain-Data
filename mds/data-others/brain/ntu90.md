...
1. Always acknowledge the **Advanced Biomedical MRI Lab, NTU Hospital** in any publications or materials.  
2. Redistribution is permitted only if this paragraph is included. Users assume all risk and liability.  
3. NTU Lab provides **no warranties** of any kind, express or implied.  
4. **Commercial use** is strictly prohibited without written consent from NTU Lab.
